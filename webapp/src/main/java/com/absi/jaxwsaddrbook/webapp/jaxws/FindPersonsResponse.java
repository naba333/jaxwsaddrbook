...
@XmlRootElement(name = "findPersonsResponse", namespace = "http://webapp.jaxwsaddrbook.absi.com/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "findPersonsResponse", namespace = "http://webapp.jaxwsaddrbook.absi.com/")
